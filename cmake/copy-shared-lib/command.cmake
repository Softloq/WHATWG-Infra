...
function(copy_softloq_whatwg_infra_shared_lib TARGET_NAME)
    if(SOFTLOQ_WHATWG_INFRA_BUILD_SHARED_LIBS AND NOT SOFTLOQ_WHATWG_INFRA_HEADER_ONLY)
        add_custom_command(
            ...
            COMMAND ${CMAKE_COMMAND} -E copy "$<TARGET_FILE_DIR:Softloq-WHATWG-Infra>/${LIB_PREFIX}Softloq-WHATWG-Infra${LIB_EXTENSION}" "$<TARGET_FILE_DIR:${TARGET_NAME}>/${LIB_PREFIX}Softloq-WHATWG-Infra${LIB_EXTENSION}"
        )
    else()
        add_custom_command(
            TARGET ${TARGET_NAME} POST_BUILD
