...
public:
    ...
    constexpr explicit CodePoint(char32_t value) noexcept
        : m_value{value}
    {
    }
...
public:
    ...
    {
        return PrimitiveType::CodePoint;
    }
...
public:
     ...
     */
    [[nodiscard]] constexpr char32_t get_value() const noexcept
    {
        return m_value;
    }
     ...
     */
    constexpr void set_value(char32_t value) noexcept
    {
        m_value = value;
    }
...
public:
     ...
     */
    [[nodiscard]] constexpr explicit operator char32_t() const noexcept
    {
        return m_value;
    }
...
public:
     ...
     */
    [[nodiscard]] constexpr bool operator==(const CodePoint& other) const noexcept
    {
