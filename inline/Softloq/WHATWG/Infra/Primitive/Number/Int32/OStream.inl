/**
 * @file Softloq/WHATWG/Infra/Primitive/Number/Int32/OStream.inl
 * @author Softloq CEO - Brandon Foster (Paradox Gene)
 * @brief Output stream operator for the Int32 primitive type in the WHATWG Infra library.
 *
 * Copyright (c) 2026 Softloq. All rights reserved.
 * Softloq implementation of the WHATWG Infra library.
 * This file defines the output stream operator for the Int32 primitive type.
 */
...
#endif // SOFTLOQ_WHATWG_INFRA_PRIMITIVE_NUMBER_INT32_OSTREAM_INL
